...
parser.add_argument('--vgg_model_path', type=str, default='./models/dex_imdb_wiki.caffemodel.pt',
                    help='pretrained age classifier')
...
# The first 10 epochs are trained on 512 x 512 images with a batch size of 4.w
batch_size = config['batch_size'] * 4
img_size = (config['input_h'] // 2, config['input_w'] // 2)
